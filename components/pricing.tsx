...
const plans: Array<Plan> = [
  {
    ...
    shortDescription: "günstige Basisversion",
    badge: "RISIKOARM EINSTEIGEN",
    price: 499,
    period: "monatlich",
    features: [
      { text: "3 Live-Marktanalysen pro Monat", included: true },
      { text: "Basic Trading-Vorlagen", included: true },
      { text: "Community-Zugang (Leserechte)", included: true },
      { text: "1 psychologisches Coaching-Video", included: true },
      { text: "Live-Mentoring Sitzungen", included: false },
      { text: "Persönliche Erfolgsanalyse", included: false },
      { text: "Premium-Community Beitritt", included: false },
    ],
    buttonText: "Jetzt kostenlos starten",
    subText: "Erste Schritte ohne Risiko - upgraden Sie bei Erfolg",
      onClick: () => {
  ...
  },
  {
    id: planType.yearly,
    name: "Pro Trader ✦",
    shortDescription: "Aktiver Marktzugang",
    badge: "MEISTGEWÄHLT",
    price: 4999,
    originalPrice: 9999,
    period: "Jährlich",
    features: [
      { text: "Tägliche Live-Trading Sessions", included: true },
      { text: "Alle Advanced Vorlagen", included: true },
      { text: "VIP-Community (Schreibrechte)", included: true },
      { text: "Wöchentliches 1:1 Feedback", included: true },
      { text: "Persönlicher Risiko-Assistent", included: true },
      { text: "Emotions-Tracking Dashboard", included: true },
      { text: "Exklusive Markt-Insider Reports", included: true },
    ],
    buttonText: "Jetzt Profi werden",
    subText: (
      <div className="flex gap-2 items-center text-emerald-600">
        50% Rabatt für erste 100 Trader (63 verbleibend)
      </div>
    ),
    onClick: () => {
  ...
  },
  {
    ...
    name: "Trading Elite ✦✦✦",
    shortDescription: "Lebenslange Premium-Mitgliedschaft",
    badge: "LIMITIERTES ANGEBOT",
    price: 9990,
    period: "einmalig",
    features: [
      { text: "Unbegrenzter Live-Mentor Zugang", included: true },
      { text: "Persönliche Trading-Strategie", included: true },
      { text: "Priority Event-Zugänge", included: true },
      { text: "Monatliche Performance-Analyse", included: true },
      { text: "Elite Mastermind Gruppe", included: true },
      { text: "24/5 Trading-Hotline", included: true },
      { text: "Lebenslange Content-Updates", included: true },
    ],
    buttonText: "Jetzt Elite-Status sichern",
    subText: (
      <div className="flex gap-2 items-center text-amber-600">
        Inklusive 3-monatige Erfolgsgarantie
      </div>
    ),
    onClick: () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Starte jetzt und lerne für Deine bessere Zukunft. Lerne langsam, aber nachhaltig.  Werde unabhängig und geniesse in Zukunft die Freiheit.
        </p>
